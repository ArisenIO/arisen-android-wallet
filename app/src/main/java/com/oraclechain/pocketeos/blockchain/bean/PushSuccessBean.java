...
public class PushSuccessBean {
     ...
     * code : 0
     * message : ok
     * data : {"transaction_id":"989af986dae459ad11574f7620bf246fafeb7fe9f9979545c3dc9cfe4aaff43e","processed":{"packed_trx_digest":"8dcc39cbb942184ea5a52cf4dd5a384d01975baf62624710a534e56310e8f661","_profiling_us":663,"deferred_transaction_requests":[],"read_locks":[{"scope":"........ehbo5","account":"arisen.token"}],"region_id":0,"action_traces":[{"context_free":false,"console":"transfer","act":{"authorization":[{"actor":"lucan222","permission":"active"}],"hex_data":"000000428869908e00a6823403ea305560ea00000000000004454f530000000019e681ade5969ce58f91e8b4a22ce5a4a7e59089e5a4a7e588a9","data":{"quantity":"6.0000 RIX","memo":"恭喜发财,大吉大利","from":"lucan222","to":"arisen.token"},"name":"transfer","account":"arisen.token"},"receiver":"arisen.token","_profiling_us":600,"cpu_usage":12017,"data_access":[{"sequence":43,"code":"arisen.token","scope":"arisen.token","type":"write"},{"sequence":5,"code":"arisen.token","scope":"lucan222","type":"write"},{"sequence":2,"code":"arisen.token","scope":"........ehbo5","type":"read"}]},{"context_free":false,"console":"","act":{"authorization":[{"actor":"lucan222","permission":"active"}],"hex_data":"000000428869908e00a6823403ea305560ea00000000000004454f530000000019e681ade5969ce58f91e8b4a22ce5a4a7e59089e5a4a7e588a9","data":{"quantity":"6.0000 RIX","memo":"恭喜发财,大吉大利","from":"lucan222","to":"arisen.token"},"name":"transfer","account":"arisen.token"},"receiver":"lucan222","_profiling_us":2,"cpu_usage":0,"data_access":[]}],"net_usage":280,"cycle_index":1,"kcpu_usage":112,"net_usage_words":35,"id":"989af986dae459ad11574f7620bf246fafeb7fe9f9979545c3dc9cfe4aaff43e","_setup_profiling_us":143,"write_locks":[{"scope":"arisen.token","account":"arisen.token"},{"scope":"lucan222","account":"arisen.token"}],"cpu_usage":114688,"shard_index":0,"status":"executed"}}
     */
    ...
    public static class DataBeanX {
        ...
        public static class ProcessedBean {
             ...
             * read_locks : [{"scope":"........ehbo5","account":"arisen.token"}]
             * region_id : 0
             ...
             * write_locks : [{"scope":"arisen.token","account":"arisen.token"},{"scope":"lucan222","account":"arisen.token"}]
             * cpu_usage : 114688
             * shard_index : 0
             * status : executed
             */
            ...
            public static class ActionTracesBean {
                 ...
                 * context_free : false
                 * console : transfer
                 * act : {"authorization":[{"actor":"lucan222","permission":"active"}],"hex_data":"000000428869908e00a6823403ea305560ea00000000000004454f530000000019e681ade5969ce58f91e8b4a22ce5a4a7e59089e5a4a7e588a9","data":{"quantity":"6.0000 RIX","memo":"恭喜发财,大吉大利","from":"lucan222","to":"arisen.token"},"name":"transfer","account":"arisen.token"}
                 * receiver : arisen.token
                 * _profiling_us : 600
                 * cpu_usage : 12017
                 * data_access : [{"sequence":43,"code":"arisen.token","scope":"arisen.token","type":"write"},{"sequence":5,"code":"arisen.token","scope":"lucan222","type":"write"},{"sequence":2,"code":"arisen.token","scope":"........ehbo5","type":"read"}]
                 */
                ...
                public static class ActBean {
                     ...
                     * hex_data : 000000428869908e00a6823403ea305560ea00000000000004454f530000000019e681ade5969ce58f91e8b4a22ce5a4a7e59089e5a4a7e588a9
                     * data : {"quantity":"6.0000 RIX","memo":"恭喜发财,大吉大利","from":"lucan222","to":"arisen.token"}
                     * name : transfer
                     * account : arisen.token
                     */
